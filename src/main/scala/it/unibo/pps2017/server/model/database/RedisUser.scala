...
import it.unibo.pps2017.server.model.database.base.UserDatabaseInterface
...
/**
  ...
  */
case class RedisUser() extends UserDatabaseInterface {
  ...
  /**
    ...
    * error handler.
    */
  override def userSignIn(username: String,
